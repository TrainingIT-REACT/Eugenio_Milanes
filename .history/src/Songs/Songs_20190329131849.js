...
class Songs extends Component {
  ...
  mouseOver = e => {
    console.log(this.reference1.current.classList.remove("fa-music"));
    console.log(this.reference1.current.classList);
    this.setState({ icons: "fa-play" });
  };

  mouseOut = e => {
    // console.log(this.reference1.current.classList.add("popo"));
    console.log(this.reference1.current.class);
